...
namespace DataStructures.Set
{
    public class DisjointSet<T> : IEnumerable<T>
    {
        ...
        public void MakeSet(T value)
        {
            ...
            newSet.Parent = newSet; //Kök eleman kendini işaret eder.
        ...
        {
            //Kümede olmayan bir elemanı bulamayız.
            if (!set.ContainsKey(value)) throw new Exception("The value is not in this set!");
        ...
        private DisjointSetNode<T> findSet(DisjointSetNode<T> node)
        {
            ...
            if (node != parent) //köke geldiğimiz node'un parent'ı kendisine eşit olacak, recursive ifadeyi kırma noktamız bu olacak.
            {
        ...
        {
            if (valueA == null || valueB == null) throw new ArgumentNullException("valueA and valueB are null.");


            //Kökler eşitse ayrık set olmaz, ayrık set değilse birleştirme olmaz
